<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeFile="QueAnsSection.aspx.cs" Inherits="WebApplication2.QueAnsSection" %>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                               <br />
                                    ...
                                    <asp:Button ID="Button2" runat="server" class="btn btn-primary" OnClick="Button2_Click" Text="View QuestionAnswer" />
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <center>
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="que_id" DataSourceID="SqlDataSource1" CssClass="auto-style4" OnRowCommand="GridView1_RowCommand" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="1034px">
                                        <Columns>
                                                                ...
                                                                <div class="card-body">
                                                                      <div class="row">
                                                                        <div class="col-12">
                                                                            ...
                                                                            <asp:Label ID="Label4" runat="server" Text='<%# Eval("que_id") %>' Font-Bold="False" Visible="false"></asp:Label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-12">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-12">
                                                                            <asp:Button ID="Button4" runat="server" CommandName="MyButtonClick" CssClass="btn btn-primary" Text="GIVE ANS" OnClick="Button4_Click" /> 
                                                                 ...
                                                                 <!--    <div class="row">
                                                                        <div class="col-12">
                                                                           ...
                                                                           <button id="Button2" type="button" runat="server" data-target="#ansmodal" data-toggle="modal" class="btn btn-primary">GIV</button>
                                                                                    ...
                                                                                    <div class="modal-content">
                                                                                        ...
                                                                                        <div class="modal-body">
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <asp:TextBox ID="TextBox1" placeholder="Type Here.." TextMode="MultiLine" Rows="4" CssClass="form-control" runat="server"></asp:TextBox>
                                                                                        ...
                                                                                        <div class="modal-footer">
                                                                                            ...
                                                                                            <asp:Button ID="Button10" runat="server" class="btn btn-success" Text="Save" Onclick="Button3_Click" />
